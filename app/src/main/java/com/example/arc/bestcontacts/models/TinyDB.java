...
public class TinyDB {
    ...
    private String key;
    private ArrayList<User> objArray;
    ...
    public ArrayList<User> getListObject(String key, Class<User> mClass){
    	Gson gson = new Gson();
    	...
    	for(String jObjString : objStrings){
    		User value  = gson.fromJson(jObjString,  mClass);
    		objects.add(value);
    	}
    	return objects;
    }
    ...
    public void putListObject(String key, ArrayList<User> objArray){
